									...
									db.Model.create({
										...
										.then((model) => {
											db.VehicleVersion.create({
												...
												.then((vehicleVersion) => {
													db.Vehicle.create({
														versionID: vehicleVersion.versionID,
														gearType: "automática",
														year: 2021,
														kilometers: 0,
														color: "black",
																	...
																	db.Post.create({
																		...
																		.then((post) => {
																			db.ImageUrl.create({
																				...
																				.catch((error) =>
																					console.log("FAILED AT FAVOURITE")
																				);
																		})
																		.catch((error) =>
																			console.log("failed at product", error)
																		);
																})
																.catch((error) =>
																	console.log("failed at vehicle", error)
																);
														})
														.catch((error) =>
															console.log("failed at vehicleVersion", error)
														);
												})
												.catch((error) =>
													console.log("failed at model", error)
												);
										})
